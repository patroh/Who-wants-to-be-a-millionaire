 ...
 * @author rohan
 */
public class after_main extends javax.swing.JFrame {

    /**
     * Creates new form after_main
     */
    public after_main() {
        initComponents();
        this.setIconImage(new ImageIcon(getClass().getResource("/pics/kbclogo.jpg")).getImage());
        this.setTitle("KBC REG.");
        this.getContentPane().setBackground(new Color(52,73,94));
    }

    /**
     * This methold is called from within the constructor to initialize the form.
    ...
    private void initComponents() {
        ...
        jLabel2.setText("KBC REGISTRATION");
        ...
        jButton1.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(44, 62, 80)));
        ...
        jLabel6.setText("Friend's gender:");
...
if(jTextField1.getText().isEmpty()  ||  jTextField2.getText().isEmpty()  ||  jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jComboBox1.getSelectedIndex()==-1)
{
JOptionPane.showMessageDialog(this,"Please fill all the details","REG ERROR",JOptionPane.ERROR_MESSAGE);
...
game_start g = null;
        try {
            ...
            Logger.getLogger(after_main.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
        Logger.getLogger(after_main.class.getName()).log(Level.SEVERE, null, ex);
    } catch (SQLException ex) {
        Logger.getLogger(after_main.class.getName()).log(Level.SEVERE, null, ex);
    }
g.name.setText(this.jTextField1.getText());
g.fname.setText(this.jTextField4.getText().trim());
g.fgender.setText((String) this.jComboBox1.getSelectedItem());
g.setVisible(true);
close();
...
if(evt.getKeyCode()==KeyEvent.VK_ENTER)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(after_main.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new after_main().setVisible(true);
            }
        });
    }
